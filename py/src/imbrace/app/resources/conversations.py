...
class AsyncConversationsResource:
    ...
    async def fetch(self, organization_id: str, filter: str, limit: int = 10000) -> Dict[str, Any]:
        res = await self._http.request("POST", f"{self._base}/v1/backend/meilisearch/{organization_id}/fetch",
