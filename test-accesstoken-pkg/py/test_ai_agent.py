...
Same coverage as the api-key variant — every method documented at
...
print(f"\n=== ai_agent resource - auth: ACCESS TOKEN (PyPI imbrace) ===")
    ...
    def _create_chat():
        ...
        r = ai.create_client_chat({
            ...
            "message": {
                "id": str(uuid.uuid4()),
                "role": "user",
                "content": "hello from sdk verify (accesstoken-py)",
                "createdAt": datetime.now(timezone.utc).isoformat(),
                "parts": [{"type": "text", "text": "hello from sdk verify (accesstoken-py)"}],
            },
        })
