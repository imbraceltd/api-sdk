...
the published `imbrace==1.0.4` (PyPI), authenticated via Access Token.

See test-api-pkg/py/test_docs_full_flow_guide.py for the API-key twin.
"""
...
print(f"\n=== DOCS: full-flow-guide.md - auth: ACCESS TOKEN (PyPI imbrace==1.0.4) ===")
