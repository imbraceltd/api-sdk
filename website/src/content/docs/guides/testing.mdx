...
> TypeScript integration tests aren't available yet — see [`py/tests/integration/`](https://github.com/imbraceltd/api-sdk/tree/main/py/tests/integration) for live API checks, or [`ts/tests/local/`](https://github.com/imbraceltd/api-sdk/tree/main/ts/tests/local) for manual live testing scripts.
