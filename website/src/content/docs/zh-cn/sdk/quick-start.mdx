---
title: 快速入门
description: 在一分钟内完成你的第一次 Imbrace API 调用。
---
...
- **AI Agent + streamChat** → [完整流程指南 §1](/zh-cn/sdk/full-flow-guide/#1-创建-ai-agent-并开始聊天)
- **Workflows** → [完整流程指南 §2](/zh-cn/sdk/full-flow-guide/#2-创建工作流并与-ai-agent-关联)
- **Knowledge Hub（文件夹、RAG）** → [完整流程指南 §3](/zh-cn/sdk/full-flow-guide/#3-管理-knowledge-hub-并绑定到-ai-agent)
