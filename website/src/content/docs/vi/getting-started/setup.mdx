...
**Tùy chọn 1 — Cổng thông tin Imbrace:** đăng nhập và đi đến **Settings → API Keys**.

**Tùy chọn 2 — qua API** (yêu cầu access token hiện có):
...
Giá trị bạn cần là `response.apiKey.apiKey`.
