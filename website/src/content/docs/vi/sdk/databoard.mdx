---
title: Data Boards
description: Tham chiếu SDK cho client.boards — pipeline CRM, mục, trường, phân đoạn, Knowledge Hub, nhập/xuất và tích hợp ổ đĩa ngoài.
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

Boards là kho dữ liệu cốt lõi cho các pipeline CRM — khách hàng tiềm năng, thỏa thuận, nhiệm vụ hoặc bất kỳ dữ liệu có cấu trúc nào. Truyền board id trong `board_ids` khi tạo AI agent để cấp quyền truy cập dữ liệu đó — xem [Hướng dẫn toàn luồng §4](/sdk/full-flow-guide/#4-manage-data-boards-and-items-crm-pipelines).
...
### Mục được liên kết (board liên quan)
