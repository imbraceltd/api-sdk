---
title: Workflows
description: Workflows — trình xây dựng workflow trực quan và tự động hóa kênh — tạo, kích hoạt và quản lý flow qua SDK.
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

SDK cung cấp hai hệ thống workflow: **Workflows** (`client.workflows`) để tự động hóa workflow trực quan và **tự động hóa kênh** (`client.workflows`) cho các luồng kênh nhắn tin như WhatsApp.

Khởi tạo client trước (xem [Cài đặt](/sdk/installation/) hoặc [Bắt đầu nhanh](/sdk/quick-start/)). Để có hướng dẫn từ đầu đến cuối kết nối workflow với assistant, xem [Hướng dẫn toàn luồng §2](/sdk/full-flow-guide/#2-create-a-workflow-and-bind-it-to-an-ai-agent).
