...
- **AI Agent + streamChat** → [Hướng Dẫn Luồng Đầy Đủ §1](/vi/sdk/full-flow-guide/#1-tạo-ai-agent-và-bắt-đầu-chat)
- **Workflows** → [Hướng Dẫn Luồng Đầy Đủ §2](/vi/sdk/full-flow-guide/#2-tạo-workflow-và-liên-kết-với-ai-agent)
- **Knowledge Hub (folders, RAG)** → [Hướng Dẫn Luồng Đầy Đủ §3](/vi/sdk/full-flow-guide/#3-quản-lý-knowledge-hub-và-gắn-vào-ai-agent)
