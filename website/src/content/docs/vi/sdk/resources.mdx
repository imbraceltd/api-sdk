---
title: Tham Chiếu Resources
description: Tham chiếu theo namespace cho Imbrace SDKs — contacts, conversations, messaging, campaigns và nhiều hơn.
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

Trang này bao gồm các CRM và messaging namespaces được SDK expose. Khởi tạo client trước (xem [Cài Đặt](/vi/sdk/installation/) hoặc [Bắt Đầu Nhanh](/vi/sdk/quick-start/)). Tất cả snippets bên dưới giả định `client` là instance đã khởi tạo.

Để xem các AI và workflow resources, xem:
- [AI Agent](/vi/sdk/ai-agent/) — assistants (`chatAi`), AI agent streaming, embeddings, parquet
- [Workflows](/vi/sdk/workflows/) — Activepieces flows và channel automation
- [Data Boards](/vi/sdk/databoard/) — CRM pipeline boards và items
