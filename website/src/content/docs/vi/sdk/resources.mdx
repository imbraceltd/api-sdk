---
title: Tham chiếu tài nguyên
description: Tham chiếu theo không gian tên cho Imbrace SDK — danh bạ, hội thoại, nhắn tin, chiến dịch và hơn thế nữa.
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

Trang này bao gồm các không gian tên CRM và nhắn tin được SDK cung cấp. Khởi tạo client trước (xem [Cài đặt](/sdk/installation/) hoặc [Bắt đầu nhanh](/sdk/quick-start/)). Tất cả đoạn mã bên dưới giả định `client` là phiên bản đã được khởi tạo.

Đối với các tài nguyên liên quan đến AI và workflow, xem:
- [AI Agent](/sdk/ai-agent/) — assistant (`chatAi`), AI agent streaming, embeddings, parquet
- [Workflows](/sdk/workflows/) — Luồng workflow và tự động hóa kênh
- [Data Boards](/sdk/databoard/) — Board pipeline CRM và mục

Để có hướng dẫn từ đầu đến cuối sử dụng các tài nguyên này cùng nhau, xem [Hướng dẫn toàn luồng](/sdk/full-flow-guide/).
...
Khả dụng cho cả TypeScript và Python.
