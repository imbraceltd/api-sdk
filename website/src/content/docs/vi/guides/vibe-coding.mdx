...
Tạo file `.env` ở thư mục gốc project. SDK **không** tự đọc biến môi trường — bạn truyền chúng vào constructor ở bước 3.
...
Xem [Authentication](/sdk/authentication/) để biết nên dùng API Key hay Access Token, và [Hướng dẫn Setup](/getting-started/setup/#get-an-api-key) để biết cách lấy API key.
