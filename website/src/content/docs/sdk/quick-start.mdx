...
> Pass `apiKey` / `api_key` instead if Imbrace is a feature inside your own backend (vs. powering it). See [Authentication](/sdk/authentication/) for the decision.
...
For the per-namespace API reference, see [Resources](/typescript/resources/) (a unified `/sdk/resources/` page is coming).
