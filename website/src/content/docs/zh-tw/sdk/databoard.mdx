---
title: 資料看板
description: client.boards 的 SDK 參考 — CRM 管道、項目、欄位、區段、知識庫、匯入/匯出與外部磁碟整合。
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

看板是 CRM 管道的核心資料儲存 — 潛在客戶、交易、任務或任何結構化資料。在建立 AI agent 時將看板 ID 以 `board_ids` 傳入，即可讓 AI agent 存取該資料 — 請參閱[完整流程指南 §4](/sdk/full-flow-guide/#4-manage-data-boards-and-items-crm-pipelines)。
...
// 依類型取得連結的看板項目（Opportunities / Tasks）
