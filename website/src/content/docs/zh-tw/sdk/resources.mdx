---
title: 資源參考
description: Imbrace SDK 各命名空間參考 — 聯絡人、對話、訊息、活動等。
---

import { Tabs, TabItem } from "@astrojs/starlight/components";

本頁涵蓋 SDK 提供的 CRM 與訊息命名空間。請先初始化客戶端（參閱[安裝](/sdk/installation/)或[快速入門](/sdk/quick-start/)）。以下所有程式碼片段假設 `client` 為已初始化的實例。

關於 AI 與工作流程相關資源，請參閱：
- [AI Agent](/sdk/ai-agent/) — 助理（`chatAi`）、AI Agent 串流、嵌入向量、Parquet
- [工作流程](/sdk/workflows/) — 工作流程流程與頻道自動化
- [資料看板](/sdk/databoard/) — CRM 管道看板與項目

如需結合使用這些資源的端到端逐步解說，請參閱[完整流程指南](/sdk/full-flow-guide/)。
