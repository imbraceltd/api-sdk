...
Manage customer conversations — view, search, and update status.
...
Manage marketing campaigns and their associated touchpoints (communication steps).
...
AI-powered reply suggestions based on conversation context.
...
Send input data to the prediction service for ML-based scoring or classification.
